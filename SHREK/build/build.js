...
var mask;
function preload() {
    mask = loadImage('assets/shrek.png');
}
function setup() {
...
function draw() {
    ...
    if (Array.isArray(positions)) {
        ellipse(positions[27][0], positions[27][1], 60, 50);
        ellipse(positions[32][0], positions[32][1], 60, 50);
        ellipse(positions[62][0], positions[62][1], 20, 20);
        imageMode(CENTER);
        image(mask, positions[33][0], positions[33][1] - 30);
        mask.resize(0, 350);
    }
    pop();
}
